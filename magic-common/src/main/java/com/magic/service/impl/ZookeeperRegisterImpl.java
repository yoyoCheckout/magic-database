...
public class ZookeeperRegisterImpl implements Register {
	...
	public ZookeeperRegisterImpl(String serviceName, int port, String zkList, int baseSleepTimeMs, int maxRetries,
		...
		CuratorFramework client = CuratorFrameworkFactory.newClient(zkList,
	 ...
	 * @throws Exception
	 */
	public ZookeeperRegisterImpl(String zkList, String zkBasePath) throws Exception {
		CuratorFramework client = CuratorFrameworkFactory.newClient(zkList, new ExponentialBackoffRetry(1000, 3));
		client.start();
